...
function AnimatedClusterDemo({ data, mode, accent }) {
    _s();
    const [phase, setPhase] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("idle");
        ...
        "AnimatedClusterDemo.useMemo[steps]": ()=>{
            if (mode === "row") {
                return [
                    ...
                    ...data.rowClusters.map({
                        "AnimatedClusterDemo.useMemo[steps]": (c, i)=>({
                                label: `Group ${i + 1}`,
                                narration: `Moving ${c.indices.map({
                                    "AnimatedClusterDemo.useMemo[steps]": (idx)=>data.rows[idx]
                                }["AnimatedClusterDemo.useMemo[steps]"]).join(" & ")} together — ${c.meaning}`
                            })
                    }["AnimatedClusterDemo.useMemo[steps]"]),
                    {
                        label: "Done",
            ...
            if (mode === "column") {
                return [
                    ...
                    ...data.colClusters.map({
                        "AnimatedClusterDemo.useMemo[steps]": (c, i)=>({
                                label: `Group ${i + 1}`,
                                narration: `Grouping ${c.indices.map({
                                    "AnimatedClusterDemo.useMemo[steps]": (idx)=>data.cols[idx]
                                }["AnimatedClusterDemo.useMemo[steps]"]).join(" & ")} — ${c.meaning}`
                            })
                    }["AnimatedClusterDemo.useMemo[steps]"]),
                    {
                        label: "Done",
            ...
            return [
                ...
                {
                    label: "Rows",
                    narration: `Pulling ${data.bicluster.rowIndices.map({
                        "AnimatedClusterDemo.useMemo[steps]": (i)=>data.rows[i]
                    }["AnimatedClusterDemo.useMemo[steps]"]).join(", ")} together.`
                },
                {
                    label: "Cols",
                    narration: `Pulling ${data.bicluster.colIndices.map({
    ...
    const rowOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnimatedClusterDemo.useMemo[rowOrder]": ()=>{
            if (phase === "idle") {
                return mode === "column" ? data.rows.map({
                    "AnimatedClusterDemo.useMemo[rowOrder]": (_, i)=>i
                }["AnimatedClusterDemo.useMemo[rowOrder]"]) : SCRAMBLED_ROWS;
            }
            if (mode === "row") {
                if (step === 0) return SCRAMBLED_ROWS;
                const groups = data.rowClusters.slice(0, step);
                const placed = new Set(groups.flatMap({
                    "AnimatedClusterDemo.useMemo[rowOrder]": (g)=>g.indices
                }["AnimatedClusterDemo.useMemo[rowOrder]"]));
                const rest = SCRAMBLED_ROWS.filter({
                    "AnimatedClusterDemo.useMemo[rowOrder].rest": (r)=>!placed.has(r)
                }["AnimatedClusterDemo.useMemo[rowOrder].rest"]);
                return [
                    ...groups.flatMap({
                        "AnimatedClusterDemo.useMemo[rowOrder]": (g)=>g.indices
                    }["AnimatedClusterDemo.useMemo[rowOrder]"]),
    ...
    const colOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnimatedClusterDemo.useMemo[colOrder]": ()=>{
            if (phase === "idle") {
                return mode === "row" ? data.cols.map({
                    "AnimatedClusterDemo.useMemo[colOrder]": (_, i)=>i
                }["AnimatedClusterDemo.useMemo[colOrder]"]) : SCRAMBLED_COLS;
            }
            if (mode === "column") {
                if (step === 0) return SCRAMBLED_COLS;
                const groups = data.colClusters.slice(0, step);
                const placed = new Set(groups.flatMap({
                    "AnimatedClusterDemo.useMemo[colOrder]": (g)=>g.indices
                }["AnimatedClusterDemo.useMemo[colOrder]"]));
                const rest = SCRAMBLED_COLS.filter({
                    "AnimatedClusterDemo.useMemo[colOrder].rest": (c)=>!placed.has(c)
                }["AnimatedClusterDemo.useMemo[colOrder].rest"]);
                return [
                    ...groups.flatMap({
                        "AnimatedClusterDemo.useMemo[colOrder]": (g)=>g.indices
                    }["AnimatedClusterDemo.useMemo[colOrder]"]),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedClusterDemo.useEffect": ()=>{
            ...
            const t = setTimeout({
                "AnimatedClusterDemo.useEffect.t": ()=>setStep({
                        "AnimatedClusterDemo.useEffect.t": (s)=>s + 1
                    }["AnimatedClusterDemo.useEffect.t"])
            }["AnimatedClusterDemo.useEffect.t"], 1400);
            return ({
                "AnimatedClusterDemo.useEffect": ()=>clearTimeout(t)
            })["AnimatedClusterDemo.useEffect"];
        }
    }["AnimatedClusterDemo.useEffect"], [
        phase,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    phase !== "idle" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: reset,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: steps.map((s, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AnimatedClusterDemo, "PC61O+2lrBj7QmsFe2TVdyPHsT4=");
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                        ...
                        children: tab === "learn" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                    ...
                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$src$2f$lib$2f$lesson$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEACHING_DATASETS"].map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$src$2f$lib$2f$heatmap$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["starsLabel"])(d.stars)
                                                }, void 0, false, {
                                                    fileName: "[project]/Documents/Notes/Visual Analytics/Exercise 5/src/components/ClusteringDashboard.tsx",
                                                    lineNumber: 110,
                                                    columnNumber: 21
                            ...
                            className: "space-y-5",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Notes$2f$Visual__Analytics$2f$Exercise__5$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ExplorePanel, {
                                datasetId: datasetId,
...
//# sourceMappingURL=Documents_Notes_Visual%20Analytics_Exercise%205_src_11x4xb5._.js.map